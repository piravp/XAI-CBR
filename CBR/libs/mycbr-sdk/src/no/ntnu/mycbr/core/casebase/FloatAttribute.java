 ...
 * @author myCBR Team
 */
public final class FloatAttribute extends SimpleAttribute implements
        Comparable<FloatAttribute> {
    ...
    /**
     * Creates a new Float attribute for the given descirption with the given
     * value.
     *
     * @param desc
     ...
     */
    FloatAttribute(final FloatDesc desc, final float v) {
        super(desc);
        this.value = v;
    }
     ...
     */
    public int compareTo(final FloatAttribute o) {
     ...
     * (non-Javadoc)
     *
     * @see SimpleAttribute#getValueAsString()
     */
    @Override
    /**
