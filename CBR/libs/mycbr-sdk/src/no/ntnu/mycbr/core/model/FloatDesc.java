...
import no.ntnu.mycbr.core.casebase.FloatAttribute;
import no.ntnu.mycbr.core.casebase.FloatRange;
...
public class FloatDesc extends SimpleAttDesc {
	 ...
	 * 
	 * @see
	 * AttributeDesc#canOverride(de.dfki.mycbr.core
	 * .model.AttributeDesc)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see AttributeDesc#addDefaultFct()
	 */
	@Override
	void addDefaultFct() {
