...
def evaluate_explanation(x, bb, dfZ, dt, tree_path, leafnode_records, bb_outcome, cc_outcome,
    ...
    eval_str = 'individual_hit: %d, local_mimic_acc %.6f, local_mimic_f1 %.6f, local_fairness_acc %.6f,\
            local_fairness_f1 %.6f, explanation_size %d, counterfactual_size %d, \
            local_logic_size %d, local_counterfactual_fairness %.6f, individual_counterfactual_hit %.6f' % (
