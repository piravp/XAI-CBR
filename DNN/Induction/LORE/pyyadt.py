...
def fit(df, class_name, columns, features_type, discrete, continuous,
    ...
    cmd = 'DNN/Induction/Lore/yadt/dTcmd -fd %s -fm %s -sep %s -d %s' % (
        data_filename, names_filename, sep, tree_filename)
    """
    print(cmd.split())
    print(os.path.dirname(os.path.realpath(__file__)))
    print(os.path.exists("yadt/dTcmd"))
    print(os.path.exists("LORE/yadt/dTcmd"))
    print(os.path.exists("Induction/LORE/yadt/dTcmd"))
    print(os.path.exists("DNN/Induction/LORE/yadt/dTcmd"))
    print(os.path.exists("DNN/Induction/LORE/yadt/dTcmd.exe"))
    """
